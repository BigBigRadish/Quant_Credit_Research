...
set fso = createobject("scripting.filesystemobject").getfolder("G:\High Yield Active Core\Hedge Trading Program\Trading Program Redux\dailyTradeFile" & timeStamp & ".xlsm")
